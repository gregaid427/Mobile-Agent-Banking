                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    helperStyle: Theme.of(context)
                        ...
                        .headline3
                        ?.copyWith(
                            fontSize: 17, color: Color.fromRGBO(78, 81, 86, 1)),
                    helperMaxLines: 10,
                    errorMaxLines: 10,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(5),
                      borderSide: BorderSide(
                          color: border! ? Colors.black45 : Colors.white),
                    ),
                    ...
                    prefixIconConstraints:
                        BoxConstraints(minHeight: 40, minWidth: 60),
  ...
  Widget? setPasswordIcon({bool? obscuredText, Function? obscurePassword}) {
    if (this.type == TextFieldType.password ||
      ...
      return IconButton(
        ...
        icon:
            obscuredText! ? Icon(Icons.visibility_off) : Icon(Icons.visibility),
